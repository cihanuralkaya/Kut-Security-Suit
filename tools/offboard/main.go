...
//
// Üretilen tek satırlık jeton, hedef cihaza KUT_OFFBOARD_TOKEN olarak (veya
// dosyayla) verilir. Ajan, gömülü KUT_OFFBOARD_PUBKEY ile doğrular; geçerliyse
...
// Public key ajanlara KUT_OFFBOARD_PUBKEY olarak gömülür.
package main
