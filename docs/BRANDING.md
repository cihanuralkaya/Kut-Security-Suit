...
KUT logosu ve türetilen uygulama ikonları `assets/` altında bulunur:
...
2. `assets/kut.ico` ve `assets/kut-icon-256.png` yazar.
...
The KUT logo and derived application icons live under `assets/`:

| File | Purpose |
|------|---------|
| `assets/kut-logo.png` | Master logo banner (1697×927) — README header, social preview. |
| `assets/kut.ico` | Multi-size Windows icon (16/32/48/64/128/256, PNG-embedded). |
| `assets/kut-icon-256.png` | Square icon preview (shield) — 256×256. |
...
(2) writes `assets/kut.ico` and `assets/kut-icon-256.png`; (3) writes an
