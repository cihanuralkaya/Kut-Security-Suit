...
// KAPALI, (3) ajan açıkça ARM'lı (KUT_ALLOW_WIPE=1). Üçü de sağlanmadıkça WIPE yalnız
...
// (KUT_ALLOW_WIPE=1 değil) döner — kazara veri kaybını önleyen üçüncü güvenlik katmanı.
var ErrWipeNotArmed = errors.New("deviceaction: WIPE ARM'lanmadı — gerçek silme için ajanda KUT_ALLOW_WIPE=1 gerekir")
...
// Yalnız KUT_ALLOW_WIPE=1 iken true. Sunucu RBAC'ı ve güvenli-moddan BAĞIMSIZ EK bir
// kilittir; üretim-dışı/yanlış yapılandırılmış dağıtımlarda kazara wipe'ı önler.
func WipeArmed() bool { return os.Getenv("KUT_ALLOW_WIPE") == "1" }
