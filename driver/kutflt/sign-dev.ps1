# sign-dev.ps1 - Create a self-signed TEST cert and test-sign kutflt.sys.
...
$pfx = Join-Path $PSScriptRoot 'kut-dev.pfx'
...
Write-Host "To trust on this dev box, export the .cer and: certutil -addstore Root kut-dev.cer"
