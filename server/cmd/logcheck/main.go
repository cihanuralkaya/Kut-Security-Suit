// Command logcheck, bir log örneğini KUT'in GERÇEK alım normalize edicilerinden
// geçirir ve elde edilen olay kayıtlarını yazar — böylece operatörler log-shipper
// çıktılarını canlıya bağlamadan ÖNCE KUT'in nasıl ayrıştırdığını doğrulayabilir.
...
//
//	# JSON: KUT yerel şeması ya da Windows olay günlüğü
...
func main() {
	...
	asJSON := flag.Bool("json", false, "gövdeyi KUT yerel JSON şeması olarak ayrıştır")
