...
func sampleData() Data {
	return Data{
		...
		TopIncidents:     []Incident{{DeviceID: "dev-1", RuleID: "KUT-0001", Severity: "CRITICAL", Count: 4, LastSeen: time.Now()}},
	}
}
...
func TestRenderHTMLContainsKPIsAndEscapes(t *testing.T) {
	...
	for _, want := range []string{"Toplam cihaz", ">10<", "Bastırılan", "KUT Security Suite"} {
