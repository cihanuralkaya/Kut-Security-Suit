...
// adaptörlerdir.
//
// NOT: Bu paket üretilen proto kodunu (kut.corp/suite/gen/kut/v1) kullanır;
...
type EnrollmentHandler struct {
	kutv1.UnimplementedEnrollmentServiceServer
	svc *enroll.Service
}
...
func (h *EnrollmentHandler) Enroll(ctx context.Context, req *kutv1.EnrollRequest) (*kutv1.EnrollResponse, error) {
...
func (h *EnrollmentHandler) RenewCertificate(ctx context.Context, req *kutv1.RenewRequest) (*kutv1.EnrollResponse, error) {
